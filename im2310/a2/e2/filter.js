...
function filterCategory(filterBy, buttonClicked){
  ...
  let filterButtonsArrayA = Array.from(document.getElementsByClassName("FilterButtonA"));
  for(let filterButtonA of filterButtonsArrayA){
    if(filterButtonA === buttonClicked){
      filterButtonA.classList.add("SelectedFilter");
    } else {
      filterButtonA.classList.remove("SelectedFilter");
    }
  }

  let filterButtonsArrayB = Array.from(document.getElementsByClassName("FilterButtonB"));
  for(let filterButtonB of filterButtonsArrayB){
    if(filterButtonB === buttonClicked){
      filterButtonB.classList.add("SelectedFilter");
    } else {
      filterButtonB.classList.remove("SelectedFilter");
    }
  }

  let filterButtonsArrayC = Array.from(document.getElementsByClassName("FilterButtonC"));
  for(let filterButtonC of filterButtonsArrayC){
    if(filterButtonC === buttonClicked){
      filterButtonC.classList.add("SelectedFilter");
    } else {
      filterButtonC.classList.remove("SelectedFilter");
    }
  }
