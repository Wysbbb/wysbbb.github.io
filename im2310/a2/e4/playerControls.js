...
let mediaPlayer = document.getElementById("videoElement");
function openFullscreen() {
  if (mediaPlayer.requestFullscreen) {
    mediaPlayer.requestFullscreen();
  } else if (mediaPlayer.webkitRequestFullscreen) { /* for safari */
    mediaPlayer.webkitRequestFullscreen();
  } else if (mediaPlayer.msRequestFullscreen) { /* for IE11 */
